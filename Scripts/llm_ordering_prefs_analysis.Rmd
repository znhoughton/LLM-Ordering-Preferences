...
gpt2_data_just_binoms$LogOverallFreq = log(gpt2_data_just_binoms$OverallFreq)

gpt2_2afc_model_just_binoms_log_freq = brm(data = gpt2_data_just_binoms,
                       log_odds ~ GenPref + RelFreq + GenPref:LogOverallFreq + RelFreq:LogOverallFreq + LogOverallFreq,
                       prior = prior_probs,
                       iter = 20000,
                       chains = 4,
                       cores = 4,
                       #control = list(adapt_delta=0.99, max_treedepth = 15),
                       control = list(max_treedepth = 20),
                       file = '../Data/gpt2_2afc_model_just_binoms_log_freq'
                      )

fixef(gpt2_2afc_model_just_binoms_log_freq)
...
gpt2xl_data_just_binoms$LogOverallFreq = log(gpt2xl_data_just_binoms$OverallFreq)

gpt2xl_2afc_model_just_binoms_log_freq = brm(data = gpt2xl_data_just_binoms,
                       log_odds ~ GenPref + RelFreq + GenPref:OverallFreq + RelFreq:OverallFreq + OverallFreq,
                       prior = prior_probs,
                       iter = 20000,
                       chains = 4,
                       ...
                       #control = list(adapt_delta=0.99, max_treedepth = 15),
                       control = list(max_treedepth = 20),
                       file = '../Data/gpt2xl_2afc_model_just_binoms_log_freq'
                      )
...
llama13b_data_just_binoms$LogOverallFreq = log(llama13b_data_just_binoms$OverallFreq + 0.000001)

llama13b_2afc_model_just_binoms_log_freq = brm(data = llama13b_data_just_binoms,
                       log_odds ~ GenPref + RelFreq + GenPref:LogOverallFreq + RelFreq:LogOverallFreq + LogOverallFreq,
                       prior = prior_probs,
                       iter = 20000,
                       chains = 4,
                       ...
                       #control = list(adapt_delta=0.99, max_treedepth = 15),
                       control = list(max_treedepth = 20),
                       file = '../Data/llama13b_2afc_model_just_binoms_log_freq'
                      )

fixef(llama13b_2afc_model_just_binoms_log_freq)
# 
# 
# options(contrasts = c("contr.sum","contr.sum"))
...
gen_pref_plot_data$model = factor(gen_pref_plot_data$model, levels = c('gpt-2', 'OlmO 1B', 'gpt-2 XL', 'Llama-2 7B',  'OlmO 7B', 'Llama-3 8B', 'Llama-2 13B', 'Llama-3 70B'), labels = c('gpt-2', 'OLMo 1B', 'gpt-2 XL', 'Llama-2 7B',  'OLMo 7B', 'Llama-3 8B', 'Llama-2 13B', 'Llama-3 70B'))

observed_pref_plot_data$model = factor(observed_pref_plot_data$model, levels = c('gpt-2', 'OlmO 1B', 'gpt-2 XL', 'Llama-2 7B',  'OlmO 7B', 'Llama-3 8B', 'Llama-2 13B', 'Llama-3 70B'), labels = c('gpt-2', 'OLMo 1B', 'gpt-2 XL', 'Llama-2 7B',  'OLMo 7B', 'Llama-3 8B', 'Llama-2 13B', 'Llama-3 70B'))
...
full_plot_data$model = factor(full_plot_data$model, levels = c('gpt-2', 'OlmO 1B', 'gpt-2 XL', 'Llama-2 7B',  'OlmO 7B', 'Llama-3 8B', 'Llama-2 13B', 'Llama-3 70B'), labels = c('gpt-2', 'OLMo 1B', 'gpt-2 XL', 'Llama-2 7B',  'OLMo 7B', 'Llama-3 8B', 'Llama-2 13B', 'Llama-3 70B'))
...
#full_plot_data = full_plot_data %>%
#  mutate(est_prob = exp(Estimate)  / (1 + exp(Estimate)))
...
full_plot = ggplot(data = full_plot_data, aes(x = `Beta Coefficient`, y = Estimate, ymin = Q2.5, ymax = Q97.5, color = color)) +
  ...
  scale_x_discrete(labels = c(expression('RelFreq'), expression('GenPref'), expression('OverallFreq'), expression('RelFreq:OverallFreq'), expression('GenPref:OverallFreq'))) +
 # ylim(c(-2.5, 10)) +
  ylab('Estimate') +
