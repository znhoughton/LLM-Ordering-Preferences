...
all_models_all_prefixes = brm(log_odds ~ GenPref * model + (GenPref * model | prompt_value),
...
all_models_all_prefixes_bigrams = brm(log_odds ~ GenPref * model * log_bigram_odds_ratio + (GenPref * model | prompt_value),
                       data = data_all_prefixes_all_models,
                       prior = prior_probs,
                       iter = 20000,
                       warmup = 10000,
...
re_df <- as.data.frame.table(re, responseName = "value")
